  ...
  return Column(
    ...
    children: [
      ...
      contactInformationWidet(
        ...
        lastNameHintText: lastNameHintText,
        lastNameController: lastNameController,
        emailIDText: emailIDText,
        emailIDhintText: emailIDhintText,
        emailIdhintController: emailIdhintController,
        mobileNumbarText: mobileNumbarText,
        mobileNumbarhintText: mobileNumbarhintText,
        mobileNumbarhController: mobileNumbarhController,
        referredmobileNumbarText: referredmobileNumbarText,
